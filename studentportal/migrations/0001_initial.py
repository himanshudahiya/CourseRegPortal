# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-04-29 11:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=12)),
                ('section_id', models.CharField(default='A', max_length=25)),
                ('dept_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.department')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.department')),
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.faculty')),
            ],
        ),
        migrations.CreateModel(
