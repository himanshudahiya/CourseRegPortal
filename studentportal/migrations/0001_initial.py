# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-04-30 11:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=12)),
                ('dept_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.department')),
                ('section_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.section')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentportal.faculty')),
                ('section_id', models.ManyToManyField(to='studentportal.section')),
            ],
        ),
        migrations.CreateModel(
            name='token',
